...
export async function GET(request, { params }) {
  ...
  try {
    ...
    // Construct the where clause to fetch students in the same class, academic year, and variant
    let whereClause = { level, schoolId, academicYear };
    // Fetch all students for the same class (level, schoolId, academicYear)
