    ...
    <div className={styles.Container}>
      <div className={styles.printoutContainer}>
        <div className={styles.reportCard} ref={contentToPrint}>
          ...
          <header className={styles.header}>
            <div className={styles.logo}>
              <div className={styles.imageContainer}>
                <img src={school.logo} alt="logo" height={100} width={130} />
              </div>
            </div>
          ...
          <h4 className={styles.performanceh4}>subject performance</h4>
            ...
            <table className={styles.table}>
              ...
              <tbody>
                {subjects.map((subject, index) => {
                  ...
                  return (
                    <tr key={index}>
                      <td>{subject.subjectName.toUpperCase()}</td>
